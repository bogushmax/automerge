declare module "automerge" {
  ...
  type ReadonlyTable<T, KeyOrder extends Array<keyof T>> = ReadonlyArray<T> &
    Table<T, KeyOrder>;
  ...
  interface FreezeTable<T, KeyOrder>
    extends ReadonlyTable<Freeze<T>, Array<keyof Freeze<T>>> {}
